  ...
  return (
    ...
    >
      <button
        ...
        onClick={scrollPrev}
        {...props}
        className="group p-[4px] rounded-[12px] cursor-pointer bg-gradient-to-b from-white to-stone-200/40 shadow-[0_1px_3px_rgba(0,0,0,0.5)] active:shadow-[0_0px_1px_rgba(0,0,0,0.5)] active:scale-[0.995]"
      >
        <div
