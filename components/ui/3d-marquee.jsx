  ...
  return (
    ...
    >
      ...
      <div
        ...
        <Link href='/getstarted' className="group hover:-translate-y-1  relative justify-center items-center flex gap-2 rounded-2xl border-2 shadow-xl text-white border-neutral-950 bg-neutral-900 px-6 py-3 font-medium duration-1000 hover:shadow-lg hover:shadow-neutral-950/50">
