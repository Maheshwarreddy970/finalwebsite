...
export default function MediaSection() {
  ...
  return (
    <div className="px-3 md:px-10 mt-16 relative">
      <div
        className={cn(
          "flex gap-4 items-center text-6xl font-semibold text-black",
      ...
      >
        ...
        <SparklesText
          colors={{ first: "#ffc400", second: "#ff9100" }}
          ...
          {mediaItems.map((item, index) => {
            ...
            return (
              <CarouselItem key={index} className="basis-[25%]">
                <div
                  className={`bg-white relative shadow-lg border rounded-xl ${
                    isReel ? "p-2.5" : "pt-1 px-2.5"
                  } overflow-hidden`}
                ...
                >
                  ...
                  <div
                    className={`relative rounded-xl transition-all flex w-full justify-center ${
                      isReel ? "bg-black" : "bg-white"
