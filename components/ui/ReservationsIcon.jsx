...
const ReservationsIcon = React.forwardRef((props, ref) => {
  const {
    initialState = false,
    onChange,
    className,
  ...
  return (
    <div
      ref={ref}
      className={`relative flex items-center h-full w-full justify-center ${className }`}
    >
      <button
        size="icon"
        onClick={handleClick}
      ...
      >
        ...
        >
          <CalendarCheck2 size={18} aria-hidden="true" className=" text-black" />
...
ReservationsIcon.displayName = "ReservationsIcon ";
