    ...
    <section className="px-3 md:px-10 pt-36 h-[60vh] md:h-screen w-full">
      ...
      <div className="flex flex-col md:flex-row md:justify-between mt-10">
        <div className={cn('text-2xl text-black', philosopher.className)}>
          Quality cars, transparent pricing, <br className="hidden md:block" /> personal service.
        </div>
        <div className="flex justify-end">
          <a
            href={`/${clientInfo?.name}/cars`}
            className="group hover:scale-105 transition-all duration-300 ease-in-out relative inline-flex h-[calc(40px+8px)] items-center justify-center rounded-full shadow-md bg-neutral-950 border border-neutral-200 py-0.5 md:py-1 pl-6 pr-14 font-medium text-white"
          >
