...
export function Dashboard({ initialData }) {
  ...
  // Debug re-renders
  useEffect(() => {
    console.log("Dashboard re-rendered, activeTab:", activeTab);
  });
  ...
  const safePercentage = (value, total) => (total > 0 ? (value / total) * 100 : 0);
  const carInventoryPercentage = safePercentage(cars.available, cars.total);
  const carsSoldPercentage = safePercentage(cars.sold, cars.total);
  const testDriveCompletionPercentage = safePercentage(testDrives.completed, testDrives.total);
  const testDriveConversionRate = testDrives.conversionRate || 0;

  return (
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        <TabsList className="bg-white mb-10">
        ...
        <TabsContent value="overview" className="space-y-6 ">
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex justify-between">
                      <p className="text-xl font-semibold">
                        {cars.available}{" "}
                        <span className="text-gray-500 text-sm font-normal">available</span>
                      </p>
                      <p className="text-xl font-semibold">
                        {cars.sold}{" "}
                        <span className="text-gray-500 text-sm font-normal">sold</span>
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex justify-between">
                      ...
                      <p className="text-xl font-semibold">
                        ...
                        <span className="text-gray-500 text-sm font-normal">confirmed</span>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <h1 className="my-6 text-2xl font-bold">Dealership Summary</h1>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 justify-between">
              ...
              <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 sm:p-1.5 md:p-2 shadow-md shadow-black/5">
                <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-2 sm:p-3 md:p-4 shadow-xl ring-1 ring-black/5">
                  <div className="flex flex-col h-full">
                    ...
                    <AnimatedRadialChart value={carInventoryPercentage} size={350} />
            ...
            >
              <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 sm:p-1.5 md:p-2 shadow-md shadow-black/5">
                <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-2 sm:p-3 md:p-4 shadow-xl ring-1 ring-black/5">
                  <div className="flex flex-col h-full">
                    <h1 className="font-semibold text-lg">Conversion Rate</h1>
                    <AnimatedRadialChart value={testDriveConversionRate} size={350} />
                    <p className="text-center text-gray-500">From test drives to sales</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 sm:p-1.5 md:p-2 shadow-md shadow-black/5">
                <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-2 sm:p-3 md:p-4 shadow-xl ring-1 ring-black/5">
                  <div className="flex flex-col h-full">
                    ...
                    <AnimatedRadialChart value={testDriveCompletionPercentage.toFixed(1)} size={350} />
              ...
              <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 shadow-md shadow-black/5">
                <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-4 shadow-xl ring-1 ring-black/5 flex flex-col h-full">
                  ...
                  <p className="text-center mt-2 text-sm text-muted-foreground">
                    {safePercentage(testDrives.pending, testDrives.total).toFixed(1)}% of bookings
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 shadow-md shadow-black/5">
                <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-4 shadow-xl ring-1 ring-black/5 flex flex-col h-full">
                  ...
                  <p className="text-center mt-2 text-sm text-muted-foreground">
                    {safePercentage(testDrives.confirmed, testDrives.total).toFixed(1)}% of bookings
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 shadow-md shadow-black/5">
                <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-4 shadow-xl ring-1 ring-black/5 flex flex-col h-full">
                  ...
                  <p className="text-center mt-2 text-sm text-muted-foreground">
                    {safePercentage(testDrives.completed, testDrives.total).toFixed(1)}% of bookings
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 shadow-md shadow-black/5">
                <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-4 shadow-xl ring-1 ring-black/5 flex flex-col h-full">
                  ...
                  <p className="text-center mt-2 text-sm text-muted-foreground">
                    {safePercentage(testDrives.cancelled, testDrives.total).toFixed(1)}% of bookings
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-2 shadow-md shadow-black/5">
              <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-4 shadow-xl ring-1 ring-black/5 flex flex-col h-full">
                ...
                <div className="flex justify-between px-8">
                  ...
                  <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white p-2 sm:p-3 md:p-4">
                    <div className="flex flex-col h-full">
                      <h1 className="font-semibold text-center text-lg">Completion Rate</h1>
                      <AnimatedRadialChart value={testDriveCompletionPercentage.toFixed(1)} size={350} />
                      <p className="text-center text-gray-500">Test drives successfully completed</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4 mt-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {testDrives.pending} (
                          {safePercentage(testDrives.pending, testDrives.total).toFixed(1)}%)
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div
                          className="bg-amber-500 h-2.5 rounded-full"
                          style={{ width: `${safePercentage(testDrives.pending, testDrives.total)}%` }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {testDrives.confirmed} (
                          {safePercentage(testDrives.confirmed, testDrives.total).toFixed(1)}%)
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div
                          className="bg-green-500 h-2.5 rounded-full"
                          style={{ width: `${safePercentage(testDrives.confirmed, testDrives.total)}%` }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {testDrives.completed} (
                          {safePercentage(testDrives.completed, testDrives.total).toFixed(1)}%)
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div
                          className="bg-blue-600 h-2.5 rounded-full"
                          style={{ width: `${safePercentage(testDrives.completed, testDrives.total)}%` }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {testDrives.cancelled} (
                          {safePercentage(testDrives.cancelled, testDrives.total).toFixed(1)}%)
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div
                          className="bg-red-500 h-2.5 rounded-full"
                          style={{ width: `${safePercentage(testDrives.cancelled, testDrives.total)}%` }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {testDrives.noShow} (
                          {safePercentage(testDrives.noShow, testDrives.total).toFixed(1)}%)
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div
                          className="bg-gray-500 h-2.5 rounded-full"
                          style={{ width: `${safePercentage(testDrives.noShow, testDrives.total)}%` }}
                        ></div>
                      </div>
                    </div>
                  </div>
