  ...
  return (
    <>
      <div className=" gap-4 grid grid-cols-1 md:grid-cols-3">
        ...
        <div className={cn(" h-full col-span-1  mt-7 bg-black/5 relative rounded-2xl", "shadow-[inset_0_0_1px_1px_#ffffff4d] sm:shadow-[inset_0_0_2px_1px_#ffffff4d]", "ring-1 ring-black/5", "mx-auto w-full", "transition-all duration-300 ease-in-out")}>
          <GlowingEffect
            spread={40}
            glow={true}
            disabled={false}
            ...
            borderWidth={3}
          />
          <div className="grid grid-cols-1 h-full rounded-2xl p-1 sm:p-1.5 shadow-md shadow-black/5">
            <div className="rounded-2xl h-full bg-white px-5 py-4 flex flex-col gap-3 shadow-xl ring-1 ring-black/5">
              <LineShadowText className="italic text-3xl font-semibold mb-4" shadowColor='black'>Car Details</LineShadowText>
        ...
        <div className={cn(" h-full col-span-2 mt-7 bg-black/5 relative rounded-2xl", "shadow-[inset_0_0_1px_1px_#ffffff4d] sm:shadow-[inset_0_0_2px_1px_#ffffff4d]", "ring-1 ring-black/5", "mx-auto w-full", "transition-all duration-300 ease-in-out")}>
          <GlowingEffect
            spread={40}
            glow={true}
            disabled={false}
          ...
          <div className="grid grid-cols-1 h-full rounded-2xl p-1 sm:p-1.5 shadow-md shadow-black/5">
            <div className="rounded-2xl h-full bg-white px-5 py-4 flex flex-col gap-3 shadow-xl ring-1 ring-black/5">
              <LineShadowText className="italic text-3xl font-semibold mb-4" shadowColor='black'>Schedule Your Test Drive</LineShadowText>
      ...
      <div className={cn("grid grid-cols-1 mt-16 w-full bg-black/5 relative rounded-2xl", "shadow-[inset_0_0_1px_1px_#ffffff4d] sm:shadow-[inset_0_0_2px_1px_#ffffff4d]", "ring-1 ring-black/5", "mx-auto w-full", "transition-all duration-300 ease-in-out")}>
        <GlowingEffect
          spread={40}
          glow={true}
          disabled={false}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {testDriveInfo.contact?.address || "Not Available"}
                    </p>
                    <p className="text-gray-600 mt-1">
                      Phone: {testDriveInfo.contact?.phone || "Not Available"}
                    </p>
                    <p className="text-gray-600">
                      Email: {testDriveInfo.contact?.email || "Not Available"}
                    </p>
                  </div>
                </div>
